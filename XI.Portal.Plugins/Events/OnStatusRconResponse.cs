...
namespace XI.Portal.Plugins.Events
{
    ...
    {
        public OnStatusRconResponse(Guid monitorId, Guid serverId, string serverName, GameType gameType, string responseData, bool monitorPlayers, bool monitorPlayerIPs) : base(monitorId, serverId, serverName, gameType)
        {
