...
using XI.Portal.Web.Portal.ViewModels.Bans;
    ...
    public class BansController : Controller
    {
        ...
        public async Task<ActionResult> Create(string id)
        {
            ...
            using (var context = contextProvider.GetContext())
            {
                ...
                var model = new CreateBanViewModel
                {
                    Player = player,
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            using (var context = contextProvider.GetContext())
            {
                ...
                var model = new EditBanViewModel
                {
        ...
        public async Task<ActionResult> Lift(string id)
        {
            ...
            using (var context = contextProvider.GetContext())
            {
                ...
                var model = new LiftBanViewModel
                {
                    Player = adminAction.Player,
                    AdminActionId = adminAction.AdminActionId,
                    Text = adminAction.Text
        ...
        public async Task<ActionResult> Claim(string id)
        {
            ...
            using (var context = contextProvider.GetContext())
            {
                ...
                var model = new ClaimBanViewModel
                {
                    Player = adminAction.Player,
                    AdminActionId = adminAction.AdminActionId,
                    Text = adminAction.Text
        ...
        public async Task<ActionResult> Claim(ClaimBanViewModel model)
        {
            using (var context = contextProvider.GetContext())
            {
                ...
                var currentUserId = User.Identity.GetUserId();
                adminAction.Admin = await context.Users.SingleAsync(u => u.Id == currentUserId);
                adminAction.Text = model.Text;
