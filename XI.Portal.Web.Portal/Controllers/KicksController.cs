...
using XI.Portal.Web.Portal.ViewModels.Kicks;

namespace XI.Portal.Web.Portal.Controllers
{
    [Authorize(Roles = XtremeIdiotsRoles.Admins)]
    public class KicksController : Controller
    {
        private readonly IContextProvider contextProvider;
        private readonly IDatabaseLogger databaseLogger;
        private readonly IManageTopics manageTopics;

        public KicksController(IContextProvider contextProvider, IDatabaseLogger databaseLogger, IManageTopics manageTopics)
        {
        ...
        public async Task<ActionResult> Create(string id)
        {
            ...
            using (var context = contextProvider.GetContext())
            {
                ...
                var model = new CreateKickViewModel
                {
                    Player = player,
        ...
        [HttpPost]
        public async Task<ActionResult> Create(CreateKickViewModel model)
        {
            using (var context = contextProvider.GetContext())
            {
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            using (var context = contextProvider.GetContext())
            {
                ...
                var model = new EditKickViewModel
                {
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(EditKickViewModel model)
        {
            using (var context = contextProvider.GetContext())
            {
