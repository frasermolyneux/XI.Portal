...
using XI.Portal.Web.Portal.ViewModels.Observations;
...
namespace XI.Portal.Web.Portal.Controllers
{
    ...
    public class ObservationsController : Controller
    {
        ...
        public ObservationsController(IContextProvider contextProvider, IDatabaseLogger databaseLogger, IManageTopics manageTopics)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Create(CreateObservationViewModel model)
        {
            using (var context = contextProvider.GetContext())
            {
                ...
                var adminAction = new AdminAction
                {
                    ...
                    Type = AdminActionType.Observation,
                    Text = model.Text,
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(EditObservationViewModel model)
        {
            using (var context = contextProvider.GetContext())
            {
