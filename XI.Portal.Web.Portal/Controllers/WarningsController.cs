...
using XI.Portal.Web.Portal.ViewModels.Warnings;
...
namespace XI.Portal.Web.Portal.Controllers
{
    ...
    public class WarningsController : Controller
    {
        ...
        public WarningsController(IContextProvider contextProvider, IDatabaseLogger databaseLogger, IManageTopics manageTopics)
        {
