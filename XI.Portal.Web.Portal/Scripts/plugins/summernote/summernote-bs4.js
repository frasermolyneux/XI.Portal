...
(function(global, factory) {
    ...
    (function($$1) {
        ...
        var dropdown = renderer.create('<div class="dropdown-menu" role="list">',
        ...
        var dropdownCheck = renderer.create('<div class="dropdown-menu note-check" role="list">',
            function($node, options) {
                var markup = $$1.isArray(options.items)
                    ? options.items.map(function(item) {
                        var value = (typeof item === "string") ? item : (item.value || "");
        ...
        var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1" role="dialog"/>',
            function($node, options) {
                if (options.fade) {
                    $node.addClass("fade");
                }
...
// - see: https://goo.gl/4bfIvA
        var inputEventName =
            (isMSIE || isEdge) ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input";
/**
 * @class core.env
 *
            ...
            Bullet.prototype.releaseList = function(clustereds, isEscapseToBody) {
                ...
                $$1.each(clustereds,
                    function(idx, paras) {
                        ...
                        $$1.each(lists.from(paras).reverse(),
                            function(idx, para) {
 ...
 */
        var Editor = /** @class */ (function() {
            ...
            Editor.prototype.initialize = function() {
                ...
                this.$editable.on(env.inputEventName,
 ...
 */
        ...
        var Buttons = /** @class */ (function() {
            ...
            Buttons.prototype.addToolbarButtons = function() {
                    ...
                    function() {
                        return _this.ui.buttonGroup([
                            _this.button({
                                ...
                                contents: _this.ui.dropdownButtonContents(_this.ui.icon(_this.options.icons.magic),
                                    _this.options),
                ...
                var _loop_1 = function(styleIdx, styleLen) {
                    ...
                    this_1.context.memo("button.style." + item,
                        function() {
                            return _this.button({
                ...
                this.context.memo("button.fontname",
                    function() {
                        ...
                        $$1.each(styleInfo["font-family"].split(","),
                        ...
                        return _this.ui.buttonGroup([
                            _this.button({
                                className: "dropdown-toggle",
                                contents: _this.ui.dropdownButtonContents('<span class="note-current-fontname"/>',
                                    _this.options),
                ...
                this.context.memo("button.fontsize",
                    function() {
                        return _this.ui.buttonGroup([
                            _this.button({
                                className: "dropdown-toggle",
                                contents: _this.ui.dropdownButtonContents('<span class="note-current-fontsize"/>',
                                    _this.options),
                ...
                this.context.memo("button.paragraph",
                    function() {
                        return _this.ui.buttonGroup([
                            _this.button({
                                className: "dropdown-toggle",
                                contents: _this.ui.dropdownButtonContents(_this.ui.icon(_this.options.icons.alignLeft),
                                    _this.options),
                ...
                this.context.memo("button.height",
                    function() {
                        return _this.ui.buttonGroup([
                            _this.button({
                                className: "dropdown-toggle",
                                contents: _this.ui.dropdownButtonContents(_this.ui.icon(_this.options.icons.textHeight),
                                    _this.options),
                ...
                this.context.memo("button.table",
                    function() {
                        return _this.ui.buttonGroup([
                                _this.button({
                                    className: "dropdown-toggle",
                                    contents: _this.ui.dropdownButtonContents(_this.ui.icon(_this.options.icons.table),
                                        _this.options),
        ...
        var LinkDialog = /** @class */ (function() {
            ...
            LinkDialog.prototype.initialize = function() {
                ...
                var footer = "<button type=\"submit\" href=\"#\" class=\"" +
                    buttonClass +
                    "\" disabled>" +
            ...
            LinkDialog.prototype.showLinkDialog = function(linkInfo) {
                ...
                return $$1.Deferred(function(deferred) {
                    ...
                    _this.ui.onDialogShown(_this.$dialog,
                        function() {
                    ...
                    _this.ui.onDialogHidden(_this.$dialog,
                        function() {
                            // detach events
 ...
 */
        ...
        $$1.fn.extend({
            ...
            summernote: function() {
                ...
                // Update options
                options.langInfo =
                    $$1.extend(true, {}, $$1.summernote.lang["en-US"], $$1.summernote.lang[options.lang]);
        ...
        $$1.summernote = $$1.extend($$1.summernote,
            {
                ...
                options: {
                    ...
                    colorsName: [
                        ...
                        [
                            "Guardsman Red", "Fire Bush", "Golden Dream", "Chelsea Cucumber", "Smalt Blue",
                            "Boston Blue", "Butterfly Bush", "Cadillac"
                        ],
                        [
                            "Sangria", "Mai Tai", "Buddha Gold", "Forest Green", "Eden", "Venice Blue", "Meteorite",
                            "Claret"
                        ],
