...
using XI.Portal.Web.ViewModels.AdmBanFileMonitor;
...
namespace XI.Portal.Web.Controllers
{
    ...
    public class AdmBanFileMonitorsController : BaseController
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            {
                var banFileMonitors =
                    await context.BanFileMonitors.Include(server => server.GameServer).OrderBy(s => s.GameServer.BannerServerListPosition).ToListAsync();
